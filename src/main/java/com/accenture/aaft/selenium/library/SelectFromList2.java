...
public class SelectFromList2 {
   ...
   * @return status
   */
  public String selectFromList2(WebDriver webDriver, String objectName, String selector, String inputValue, String selection, ExtentTest extentTest, String controlName) {
	...
	CTLogger.writeToLog("SelectFromList2", "selectFromList2() ", " objectName - " + objectName + ".. input - " + inputValue + ".. selection - " + selection);
	...
	try {
	  ...
	  try {
		...
		CTLogger.writeToLog("SelectFromList2", "selectFromList2()", " Object not found exeption thrown  --> path : " + objectName);
