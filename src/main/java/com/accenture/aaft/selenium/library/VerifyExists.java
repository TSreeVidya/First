...
public class VerifyExists {
   ...
   * @return status
   */
  public String verifyExists(WebDriver webDriver, String objectName, String selector, String inputValue, ExtentTest extentTest, String controlName) {

	CTLogger.writeToLog("VerifyExists", "verifyExists()", " method called");
...
*/
	  ...
	  if (status.equals("true")) {
		extentTest.log(LogStatus.PASS, " verified " + controlName + " exists");
	  } else {
		CTLogger.writeToLog("VerifyExists", "verifyExists()", " Object not found --> path : " + objectName + " --> " + controlName);
	  ...
	  try {
		...
		CTLogger.writeToLog("VerifyExists", "verifyExists()", " Exception thrown  --> path : " + objectName + " --> " + controlName);
